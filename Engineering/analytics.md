...
| `self_check_submitted` | The request to `/api/diagnose` carries the 5-item self-check (Code 7 fallback or pre-filing flow). | `answers`: the 5 yes/no/unsure values | Server (`app/api/diagnose/route.ts`) |
